...
printf("M_earth = %e ; M_sun = %e ; V_earth = %e ; R_perihelion = %e  \n", ((IndividualImpl*)bBest)->mass_earth, ((IndividualImpl*)bBest)->mass_sun, ((IndividualImpl*)bBest)->speed_earth_sun, ((IndividualImpl*)bBest)->distance_earth_sun);
}
...
IndividualImpl::IndividualImpl() : CIndividual() {
  ...
  // Genome Initialiser
#line 57 "gravitationuniv.ez"

(*this).mass_sun = globalRandomGenerator->random(1.989e+28, 2.011e+32);  //mass of sun 
(*this).mass_earth = globalRandomGenerator->random(5.97e+22, 6.03e+26); //mass of earth
(*this).speed_earth_sun = globalRandomGenerator->random(20.29e+03, 38.71e+03); //speed of earth
(*this).distance_earth_sun = globalRandomGenerator->random(147.1e+8, 152.1e+10); //distance at perihelion
...
float IndividualImpl::evaluate(){
  if(valid)
    ...
    valid = true;
    #line 76 "gravitationuniv.ez"

float fScore=0;
for (int i=0;i<NB_SAMP;i++) {
  float x=sample[i][0];
  float x_earth = (*this).speed_earth_sun*x+(*this).distance_earth_sun; //x position of earth
  float y_earth = sample[i][1];
  float F = (G*(*this).mass_earth*(*this).mass_sun)/((x_earth)*(x_earth)+(y_earth)*(y_earth));
  fScore+=80090
}
...
string IndividualImpl::serialize(){
	...
	EASEA_Line << this->distance_earth_sun << " ";
	EASEA_Line << this->speed_earth_sun << " ";
...
IndividualImpl::IndividualImpl(const IndividualImpl& genome){
  ...
  // Memberwise copy
    distance_earth_sun=genome.distance_earth_sun;
    speed_earth_sun=genome.speed_earth_sun;
