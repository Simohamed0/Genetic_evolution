...
/**
 This is program entry for STD template for gravitationuniv
...
int main(int argc, char** argv){
	...
	parseArguments("gravitationuniv.prm",argc,argv);
	...
	gravitationunivInit(argc,argv);

	CPopulation* pop = ea->getPopulation();

	ea->runEvolutionaryLoop();

	gravitationunivFinal(pop);
